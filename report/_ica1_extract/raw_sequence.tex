% Auto-extracted from ICA_1.docx — do not hand-edit without re-run

% ---
Table of Figures

% ---
Figure 1 Expansion of the digital attack surface as IoT devices multiply in home and SMB environments11

% ---
Figure 2 IoT-Specific threat categories relevant to availability and monitoring.12

% ---
Figure 5 System Architecture25

% ---
Figure 6 Login and Authentication Interface26

% ---
Figure 7 Dashboard27

% ---
Figure 8 Active and Resolved Alerts27

% ---
Figure 9 Heartbeat Mechanism28

% ---
Figure 10 Data Storage30

% ---
Figure 11 Backend Structure32

% ---
Figure 12 Qualitative Performance40

% ---
Table of Tables

% ---
Table 1 Comparison of consumer IoT applications, enterprise SIEM-style monitoring, and the proposed solution across deployment and privacy dimensions.15

% ---
Table 2 Functional Requirements17

% ---
Table 3 Non-Functional Requirements18

% ---
Table 4 Mapping of project objectives (\S{}5.3) to report chapters.19

% ---
Table 5 FR1--FR8 mapped to design (Ch.9), implementation (Ch.10), and testing (Ch.11) subsections21

% ---
Table 6 NFR1--NFR7 mapped subsections.22
...
% ---
To define functional and nonfunctional requirements for a lightweight IoT monitoring platform that does not rely on additional hardware.
...
% ---
Growth of IoT and Expanding Attack Surface
...
% ---
Figure 1 Expansion of the digital attack surface as IoT devices multiply in home and SMB environments
...
% ---
Figure 2 IoT-Specific threat categories relevant to availability and monitoring.

% ---
Limitations of Existing Consumer and SMB Solutions
...
% ---
Security-Driven Availability and Anomaly Detection
...
% ---
Intrusion Detection and Monitoring in IoT Environments
...
% ---
Availability Monitoring and Heartbeat Mechanisms
...
% ---
Commercial and Academic Solutions
...
% ---
Table 1 Comparison of consumer IoT applications, enterprise SIEM-style monitoring, and the proposed solution across deployment and privacy dimensions.
...
% ---
Table 4 Mapping of project objectives (\S{}5.3) to report chapters.
...
% ---
Table 5 FR1--FR8 mapped to design (Ch.9), implementation (Ch.10), and testing (Ch.11) subsections
...
% ---
Table 6 NFR1--NFR7 mapped subsections.
...
\begin{figure}[htbp]
  ...
  \caption{Figure 6 Login and Authentication Interface}
  \label{fig:ica1_5}
\end{figure}
...
% ---
Figure 8 Active and Resolved Alerts
...
\begin{figure}[htbp]
  ...
  \caption{Figure 9 Heartbeat Mechanism}
  \label{fig:ica1_8}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{Figure 11 Backend Structure}
  \label{fig:ica1_10}
\end{figure}
...
% ---
Database Management and Performance Considerations
...
\begin{figure}[htbp]
  ...
  \caption{Figure 12 Qualitative Performance}
  \label{fig:ica1_11}
\end{figure}
...
% ---
Improved Availability and Resilience Detection
...
% ---
User Experience and Visualisation Improvements
...
% ---
Integration and Commercial Considerations
